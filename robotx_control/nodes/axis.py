...
class Axis:
    def __init__(self, hostname, username, password, width, height, frame_id,
        ...
        self.st = None
        self.pub = rospy.Publisher("image_raw/compressed", CompressedImage, self, queue_size=50)
        self.caminfo_pub = rospy.Publisher("camera_info", CameraInfo, self, queue_size=50)
