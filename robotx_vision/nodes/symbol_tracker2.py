...
from robotx_vision.symbol_detector import SymbolDetector
from robotx_vision.lk_tracker import LKTracker

class FaceTracker(SymbolDetector, LKTracker):
    def __init__(self, node_name):
        super(SymbolTracker, self).__init__(node_name)
